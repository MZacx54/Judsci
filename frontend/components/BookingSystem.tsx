                ...
                {step === 1 ? (
                  ...
                  <form onSubmit={handleSubmit} className="animate-in slide-in-from-right-4 duration-300 flex flex-col h-full">
                    ...
                    <div className="mt-auto pt-8">
                      <button
                        type="submit"
                        className="w-full py-4 bg-green-700 hover:bg-green-800 text-white font-bold rounded-xl shadow-lg shadow-green-700/20 transition-all transform active:scale-[0.98]"
                      >
                        Confirm Booking
                      </button>
                    </div>
